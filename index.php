    ...
    <header>
        ...
        <div class="container-menu-desktop">
            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop container">
                    ...
                    <!-- Logo desktop -->
                    <a href="#" class="logo">
                        <img src="view/images/craftplace-logo.png" alt="IMG-LOGO">
                    </a>
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu">
                            ...
                            <li>
                                <a href="view/login_vendedor.php">Vender</a>
                            </li>
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="index.html"><img src="view/images/craftplace-logo.png" alt="IMG-LOGO"></a>
            </div>
        ...
        <div class="menu-mobile">
            ...
            <ul class="main-menu-m">
                ...
                <li>
                            ...
                            <li>
                                <a href="view/login-vendedor.php">Vender</a>
                            </li>
                ...
                <li>
                    <a href="view/html/shoping-cart.html" class="label1 rs1" data-label1="hot">Features</a>
                </li>
            ...
            <div class="header-cart-content flex-w js-pscroll">
                ...
                <div class="w-full">
                    ...
                    <div class="header-cart-buttons flex-w w-full">
                        <a href="view/html/shoping-cart.html" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
                            View Cart
                        </a>

                        <a href="view/html/shoping-cart.html" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
                            Check Out
                        </a>
                    </div>
                </div>
    ...
    <section class="section-slide">
        <div class="wrap-slick1">
            <div class="slick1">
                ...
                <div class="item-slick1" style="background-image: url(view/images/slider-03.jpg);">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        <img src="view/images/ceramica.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="view/images/tejidos.png" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="view/images/madera.png" alt="IMG-BANNER">
        ...
        <div class="container">
            ...
            <div class="row isotope-grid">
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ceramica">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/tetera.jpg" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item cuero">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/zapato.jpg" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item tejido">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/alfombra.jpg" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ceramica">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/tazon.jpg" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ceramica">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/jarron.jpg" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ceramica">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/conejo.jpg" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item madera">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/animales.jpg" alt="IMG-PRODUCT">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item madera">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="view/images/palma.jpg" alt="IMG-PRODUCT">
